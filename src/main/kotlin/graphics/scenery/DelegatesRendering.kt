 ...
 * @author Ulrik Guenther <hello@ulrik.is>
 */
open class DelegatesRendering(val delegationType: DelegationType = DelegationType.OncePerDelegate, var delegate: Renderable? = null): AbstractNode("DelegatesRendering") {

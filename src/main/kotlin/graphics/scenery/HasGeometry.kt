...
//                        }
        ...
        logger.info("Read ${vertexCount / vertexSize}/${normalCount / vertexSize}/${uvCount / texcoordSize}/$indexCount in ${boundingBox.joinToString(", ")} v/n/uv/i of model $name in ${(end - start) / 1e6} ms")
    }

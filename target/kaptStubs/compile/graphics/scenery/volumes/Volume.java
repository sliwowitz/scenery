...
public class Volume extends graphics.scenery.Mesh {
    ...
    private java.util.HashMap<java.lang.String, java.lang.Object> shaderProperties;
    ...
    public static void shaderProperties$annotations() {
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.HashMap<java.lang.String, java.lang.Object> getShaderProperties() {
        return null;
    }
    
    public final void setShaderProperties(@org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    protected final cleargl.GLTypeEnum toGLType(@org.jetbrains.annotations.NotNull()
    coremem.enums.NativeTypeEnum $receiver) {
        return null;
    }
    
    protected final void assignEmptyVolumeTexture() {
    }
    
    protected final void assignVolumeTexture(@org.jetbrains.annotations.NotNull()
    long[] dimensions, @org.jetbrains.annotations.NotNull()
    graphics.scenery.volumes.Volume.VolumeDescriptor descriptor, boolean replace) {
    }

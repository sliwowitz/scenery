...
public class OpenGLShaderModule {
    ...
    private final void setShader(cleargl.GLShader p0) {
    }
    ...
    private final void setShaderType(graphics.scenery.backends.ShaderType p0) {
    }

...
public abstract interface Display {
     ...
     */
    public abstract void submitToCompositorVulkan(int width, int height, int format, @org.jetbrains.annotations.NotNull()
